...
void SQLInsertIncomeLastThreeMonths(string username, string subquestion1, string subquestion2, string subquestion3)
{
	con->setSchema("finance");
    pstmt = con->prepareStatement("INSERT INTO IncomeLastThreeMonths(Username,FirstM,SecondM,ThirdM) VALUES (?,?,?,?)"); // prepare the insert into statement
